...
def print_result(pkgs):
    ...
    if not pkgs:
        ...
        for pkg in security_updates:
            ...
            output['security updates'][pkg.get('name')]['current'] = pkg.get('current_version')
            output['security updates'][pkg.get('name')]['latest'] = pkg.get('candidate_version')
    return output

if __name__ == '__main__':
    print("Please run monitoring.py")
    #pkgs = get_update_packages()
    #print(str(print_result(pkgs)))